...
public record ProcessParamsDto(InputAdapter inputAdapter, InputReader inputReader, OutputAdapter outputAdapter, OutputWriter outputWriter, String valueToProcess) {
}
